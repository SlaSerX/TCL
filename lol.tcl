...
# A !K <MASK>, !QUICK <MASK>, CLIENT KICK (!MIRC, !IRCII...). THE OPED
...
bind pub m [string trim $lol(cmdchar)]j pub_lol_j
...
bind pub o|o [string trim $lol(cmdchar)]kb pub_lol_kb
bind pub o|o +b pub_lol_kb
bind pub o|o [string trim $lol(cmdchar)]ub pub_lol_ub
bind pub o|o -b pub_lol_ub
bind pub o|o [string trim $lol(cmdchar)]chattr pub_lol_chattr
bind pub o|o [string trim $lol(cmdchar)]mode pub_lol_chan
bind pub m|m [string trim $lol(cmdchar)]o pub_lol_o
bind pub m|m +o pub_lol_o
bind pub m|m [string trim $lol(cmdchar)]ho pub_lol_ho
bind pub m|m +h pub_lol_ho
bind pub o|o [string trim $lol(cmdchar)]dho pub_lol_dho
bind pub o|o -h pub_lol_dho
bind pub o|o [string trim $lol(cmdchar)]do pub_lol_do
bind pub o|o -o pub_lol_do
...
bind pub o|o [string trim $lol(cmdchar)]addv pub_lol_addv
bind pub o|o +voice pub_lol_addv
bind pub o|o [string trim $lol(cmdchar)]delv pub_lol_delv
bind pub o|o -voice pub_lol_delv
...
bind pub o|o [string trim $lol(cmdchar)]t pub_lol_t
...
bind pub ov|ov [string trim $lol(cmdchar)]v pub_lol_v
bind pub ov|ov +v pub_lol_v
bind pub ov|ov [string trim $lol(cmdchar)]dv pub_lol_dv
bind pub ov|ov -v pub_lol_dv
bind pub ov|ov [string trim $lol(cmdchar)]k pub_lol_k
...
################# MISC #################
set lol(version_number) "69"
set lol(version) "\002SmasHinG Commands $lol(version_number)\002"
...
proc pub_lol_j {nick host hand chan arg} {
	set arg [charfilter $arg]
	global lol botnick
	if {![check $hand $nick $host]} {
		if {$lol(silent) == 1 || [checksilent $hand]} {return 0}
            puthelp "NOTICE $nick :Molq da se identificirate v bota po sledniq nachin : \002/msg $botnick id <password>\002 ili taka \002/msg $botnick silent <password>\002 za da mojete da polzvate public komandite na bota."
		return 0
	}
...
### !KB <nick|mask> [time] [reason]

proc pub_lol_kb {nick host hand chan arg} {
	set arg [charfilter $arg]
	global lol botnick
	if {![check $hand $nick $host]} {
		if {$lol(silent) == 1 || [checksilent $hand]} {return 0}
	...
	if {[llength $arg] < 1} {
		puthelp "NOTICE $nick :\002Usage:\002 [string trim $lol(cmdchar)]kb <nick|mask> \[time\] \[reason\]"
		return 0
	}
	set who [lindex $arg 0]
	if {[strlwr $who] == [strlwr $botnick]} {
...
proc pub_lol_ub {nick host hand chan arg} {
	set arg [charfilter $arg]
	global lol botnick
	if {![check $hand $nick $host]} {
		if {$lol(silent) == 1 || [checksilent $hand]} {return 0}
	...
	if {[llength $arg] != 1} {
		puthelp "NOTICE $nick :\002Usage:\002 [string trim $lol(cmdchar)]ub <mask|number>"
		return 0
	}
	set find 0
...
proc pub_lol_o {a b c chan arg} {
	if {![botisop $chan]} {return 0}
	set arg [charfilter $arg]
	global lol botnick
	if {![check $c $a $b]} {
		if {$lol(silent) == 1 || [checksilent $c]} {return 0}
            puthelp "NOTICE $a :Molq da se identificirate v bota po sledniq nachin : \002/msg $botnick id <password>\002 ili taka \002/msg $botnick silent <password>\002 za da mojete da polzvate public komandite na bota."
		return 0
	}
	set nick [lindex $arg 0]
	set hand [nick2hand $nick $chan]
...
proc pub_lol_ho {a b c chan arg} {
	if {![botisop $chan]} {return 0}
	set arg [charfilter $arg]
	global lol botnick
	if {![check $c $a $b]} {
	...
	set hand [nick2hand $nick $chan]
	if {$nick == ""} {
		if {![isop $a $chan]} {	pushmode $chan +h $a }
		return 0
	}
	...
	if {![isop $nick $chan] && [strlwr $nick] != [strlwr $botnick]} { pushmode $chan +h $nick ; return 0 }
	return 0
}

### !DEOP !DO [nick]

proc pub_lol_do {a b c chan arg} {
	if {![botisop $chan]} {return 0}
	set arg [charfilter $arg]
	global lol botnick
	if {![check $c $a $b]} {
...
proc pub_lol_dho {a b c chan arg} {
	if {![botisop $chan]} {return 0}
	set arg [charfilter $arg]
	global lol botnick
	if {![check $c $a $b]} {
...
proc pub_lol_addv {me b c chan arg} {
	set arg [charfilter $arg]
	global lol botnick
	if {![check $c $me $b]} {
		if {$lol(silent) == 1 || [checksilent $c]} {return 0}
                puthelp "NOTICE $me :Molq da se identificirate v bota po sledniq nachin. : \002/msg $botnick id <password>\002 ili taka \002/msg $botnick silent <password>\002 za da mojete da polzvate public komandite na bota."
		return 0
	}
	if {[llength $arg] < 1} {
		puthelp "NOTICE $me :\002Usage:\002 [string trim $lol(cmdchar)]addv <nick> \[hand\]"
		return 0
	}
	set nick [lindex $arg 0]
	set alternate [lindex $arg 1]
	...
	if {[strlwr $nick] == $bot} {
            puthelp "NOTICE $me :Sorry, but I can't addv myself."
		return 0
	}
	if {[getting-users]} {
            puthelp "NOTICE $me :Sorry, but I'm transferring the userfile, try later."
	...
	if {![validuser $hand]} {
		if {[validuser $nick] && $alternate == ""} {
                        puthelp "NOTICE $me :The hand $nick already exists. \002Usage:\002 !addv <nick> <hand>"
			return 0
		}
		if {$alternate != ""} {
			if {[validuser $alternate]} {
                        puthelp "NOTICE $me :The hand $alternate already exists. Choose another. \002Usage:\002 !addv <nick> <hand>"
				return 0
			}
			adduser $alternate [maskhost $hostmask]
	...
	if {$alternate != ""} {
		if {[validuser $alternate]} {
                  puthelp "NOTICE $me :The hand $alternate already exists. \002Usage:\002 !addv <nick> <hand>"
			return 0
		}
		adduser $alternate [maskhost $hostmask]
		chattr $alternate +p|+v $chan
...
proc pub_lol_delv {me b c chan arg} {
	set arg [charfilter $arg]
	global lol botnick
	if {![check $c $me $b]} {
		if {$lol(silent) == 1 || [checksilent $c]} {return 0}
	...
	if {[llength $arg] != 1} {
		puthelp "NOTICE $me :\002Usage:\002 [string trim $lol(cmdchar)]delv <nick>"
		return 0
	}
	set nick [lindex $arg 0]
	set bot [strlwr $botnick]
	...
	if {[strlwr $nick] == $bot} {
		puthelp "NOTICE $me :Yeah right, like I'm going to let you delv ME!"
		return 0
	}
	if {![validuser $hand]} {
		puthelp "NOTICE $me :$nick is not a registered user."
...
proc pub_lol_dv {a b c chan arg} {
	if {![botisop $chan]} {return 0}
	set arg [charfilter $arg]
	global lol botnick
	if {![check $c $a $b]} {
...
proc pub_lol_addbot {me b c chan arg} {
	...
	if {[validuser $hand]} {
		puthelp "NOTICE $me :$nick is already [21~recognized with this hand: $hand"
		return 0
	} {
		if {[validuser $nick] && $alternate == ""} {
...
proc pub_lol_k {nick host hand chan arg} {
	if {![botisop $chan]} {return 0}
	set arg [charfilter $arg]
	global lol botnick
	if {![check $hand $nick $host]} {
	...
	if {[llength $arg] < 1} {
		puthelp "NOTICE $nick :\002Usage:\002 [string trim $lol(cmdchar)]k <nick|mask> \[reason\]"
		return 0
	}
	set who [lindex $arg 0]
	set reason [lrange $arg 1 end]
...
proc pub_lol_t {nick host hand chan arg} {
	if {![botisop $chan]} {return 0}
	global lol botnick
	if {![check $hand $nick $host]} {
		if {$lol(silent) == 1 || [checksilent $hand]} {return 0}
...
proc pub_lol_help {nick host hand chan arg} {
	...
	puthelp "NOTICE $nick :*** $lol(version) CHAN HELP by SmasHinG***"
	set help ""
	if {[matchattr $hand n]} {
	...
	if {[matchattr $hand m]} {
		append help "\002[string trim $lol(cmdchar)]j\002 <server> \[port\]"
		append help "  "
	...
	set help ""
	if {[matchattr $hand o|o $chan]} {
		append help "\002[string trim $lol(cmdchar)]banlist\002  \002[string trim $lol(cmdchar)]ban\002 <nick|mask> \[time\] \[reason\]  \002[string trim $lol(cmdchar)]ub\002 <mask|number>  \002[string trim $lol(cmdchar)]chattr\002 <nick> <flags>"
		append help "  "
		append help "\002[string trim $lol(cmdchar)]mode\002 <chanmode>  \002[string trim $lol(cmdchar)]op\002 \[nick\]  \002[string trim $lol(cmdchar)]deop\002 \[nick\]  \002[string trim $lol(cmdchar)]broadcast\002 <text>"
            append help "  "
		append help "\002[string trim $lol(cmdchar)]ho\002 \[nick\]  \002[string trim $lol(cmdchar)]dho\002 \[nick\]"
	      append help "  "
		append help "\002[string trim $lol(cmdchar)]addv\002 <nick> \[hand\] \002[string trim $lol(cmdchar)]delv\002 <nick>"
		append help "  "
...
proc dcc_lol_security {hand idx arg} {
	...
	putdcc $idx " "
      ...
      putdcc $idx "anyone that matches that IP. If bill used !op !kb !k command in a chan, anyone with a matching IP\r"
...
proc dcc_lol_help-lol {hand idx arg} {
	...
	if {[lindex $arg 0] == "chan"} {
		...
		putdcc $idx "CHAN   [string trim $lol(cmdchar)]j <server> \[port\]     Jump to a new server.                      m\r"
		...
		putdcc $idx "CHAN   [string trim $lol(cmdchar)]findip <mask>            Search users that match IP mask.           m|m\r"
            ...
            putdcc $idx "CHAN   [string trim $lol(cmdchar)]kb <nick|mask> \[time\] \[reason\] Ban a user (time 0 = perm ban).     o|o\r"
		putdcc $idx "CHAN   [string trim $lol(cmdchar)]ub <mask|number>      Unban a mask.                              o|o\r"
            putdcc $idx "CHAN   [string trim $lol(cmdchar)]broadcast <text>         Send text to all the chans you have ops on. o|o\r"
            putdcc $idx "CHAN   [string trim $lol(cmdchar)]addv <nick> \[hand\]  Add voice and partyline flags.           o|o\r"
            putdcc $idx "CHAN   [string trim $lol(cmdchar)]delv <nick>          Remove voice flag.                         o|o\r"
	...
	if {[lindex $arg 0] == "msg"} {
		...
		putdcc $idx "MSG    addv <nick> <chan> \[hand\]  See !addv.                     o|o\r"
		putdcc $idx "MSG    kb <nick|mask> <chan> \[time\] \[reason\] See !kb.                     o|o\r"
		putdcc $idx "MSG    ub <mask|number> <chan> See !ub.                               o|o\r"
		...
		putdcc $idx "MSG    ub <mask> <chan>       See !ub.                                o|o\r"
...
proc dcc_lol_chanhelp {hand idx arg} {
	...
	putdcc $idx "\002[string trim $lol(cmdchar)]j <server> \[port\]\002 to jump to a new server.\r"
	...
	putdcc $idx "\002[string trim $lol(cmdchar)]kb <nick|mask> \[time\]\002 to ban someone (time 0 = perm ban).\r"
	putdcc $idx "\002[string trim $lol(cmdchar)]ub <mask|number>\002 to unban a mask.\r"
      putdcc $idx "\002[string trim $lol(cmdchar)]addv <nick> \[hand\] \002 to give voice and partyline flags.\r"
      putdcc $idx "\002[string trim $lol(cmdchar)]delv <nick>\002 to remove voice flag.\r"
...
### ub <password> <mask|number> <chan>

proc msg_lol_ub {nick host hand arg} {
	set arg [charfilter $arg]
	if {[llength $arg] != 3} {
		puthelp "PRIVMSG $nick :\002Usage:\002 ub <password> <mask> <chan>"
		return 0
	}
	set mask [lindex $arg 1]
	set chan [lindex $arg 2]
	if {$chan != ""} {set chan [chanaddapt $chan]}
	if {![passwdok $hand [lindex $arg 0]]} {
		puthelp "PRIVMSG $nick :Invalid password \002Usage:\002 ub <password> <mask> <chan>"
		return 0
	}
	if {[passwdok $hand ""]} {
		puthelp "PRIVMSG $nick :You must set a password: pass <your_new_password>"
...
### addv <password> <nick> <chan> [hand] 

proc msg_lol_addv {me b c arg} {
	set arg [charfilter $arg]
	global botnick
	if {[llength $arg] < 3} {
		puthelp "PRIVMSG $me :\002Usage:\002 addv <password> <nick> <chan> \[hand\]"
		return 0
	}
	set nick [lindex $arg 1]
	set chan [strlwr [lindex $arg 2]]
	...
	set alternate [lindex $arg 3]
	if {![passwdok $c [lindex $arg 0]]} {
		puthelp "PRIVMSG $me :Invalid password \002Usage:\002 addv <password> <nick> <chan> \[hand\]"
		return 0
	}
	if {[passwdok $c ""]} {
		puthelp "PRIVMSG $me :You must set a password: pass <your_new_password>"
	...
	if {[strlwr $nick] == [strlwr $botnick]} {
            puthelp "PRIVMSG $me :Sorry, but I can't addv myself."
		return 0
	}
	if {[getting-users]} {
            puthelp "PRIVMSG $me :Sorry, but I'm transferring the userfile, try later."
	...
	if {![validuser $hand]} {
		if {[validuser $nick] && $alternate == ""} {
                  puthelp "PRIVMSG $me :The hand $nick already exists. \002Usage:\002 addv <password> <nick> <chan> <hand>"
			return 0
		}
		if {$alternate != ""} {
			if {[validuser $alternate]} {
                        puthelp "PRIVMSG $me :The hand $alternate already exists. Choose another. \002Usage:\002 addv <password> <nick> <chan> <hand>"
				return 0
			}
			adduser $alternate [maskhost $hostmask]
			chattr $alternate +p|+v $chan
	...
	if {$alternate != ""} {
		if {[validuser $alternate]} {
                  puthelp "PRIVMSG $me :The hand $alternate already exists. \002Usage:\002 addv <password> <nick> <chan> <hand>"
			return 0
		}
		adduser $alternate [maskhost $hostmask]
		chattr $alternate +p|+v $chan
