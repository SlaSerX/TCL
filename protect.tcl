...
proc punish {nick uhost hand chan} {
  ...
  if {[string match *@* $uhost]} {
    putquick "PRIVMSG CS :akick $chan add $nick!*@* Наруши правилата на канала, за това го наказвам...by SmasHinG"
  } else {
    putquick "PRIVMSG CS :akick $chan add $uhost!*@* Наруши правилата на канала, за това го наказвам...by SmasHinG"
  }

  putquick "PRIVMSG CS :clear $chan all"
  newban $nick!*@* $botnick "Наруши правилата на канала, за това ще бъдеш наказан...by SmasHinG" 0
  ...
  setuser $nick XTRA "Ei Takiva kato Teb nai-mnogo gi obi4am"
  putquick "JOIN $chan"
  putlog "Protect TCL Loaded..."

  if {$Protect(ExtremelyFast) == 1 && [botonchan $chan] == 1 && [botisop $chan] == 1} {
    putquick "MODE $chan -o $nick"
    putquick "MODE $chan +b $nick!*@*"
    putquick "KICK $chan $nick :Наруши правилата на канала, за това ще бъдеш наказан...by SmasHinG"
  }
}
