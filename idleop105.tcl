#         Script : IdleOP v1.05 by David Proper (Dr. Nibble [DrN])
...
#                 06/23/2002 - v1.04
#                              o Fixed missing bracket error.
#                                (Reported by |^Jax^|@DALnet. Thanks.)
#                              o Fixed another bracket missing error
#                              o Fixed variable name error
#                              o Added variable to turn off DeOPing
#                 07/13/2003 - v1.05
#                              o Fixed not showing idle time when set to 0
#                                (Reported by Dan)
#
#
#############################################################################
