...
set cs(global) {
 ...
 trimlimit=1
 adinterval=0
 adsite=http://www.siteto.com
 update=5
 htmsuffix=.htm
 ulmethod=0
 localfolder=/eggdrop/stats/
 ftpname=Hostname
 ftpport=21
 ftpfolder=/home/boqn/ruse/stats/
 username=usera
 password=passa
}
...
proc cs:ini {} {
 ...
 putlog "TCL LOADED: CHATstats [join [split $cs(scriptver) {}] .] by Baerchen"
 cs:read
