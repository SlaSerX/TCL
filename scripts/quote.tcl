...
#      v1.3en (17/10/2007)  by MenzAgitat       #
#                                               #
...
#######################
  ...
  # example : "#chan1 #chan2 #chan3" ou "#chan1"
  variable allowed_chans "#neworder"
...
####################################################################
  ...
  bind pub $quoteauth $quotecmd pubqsys::quote
  bind pub $addquoteauth $addquotecmd pubqsys::addquote
  bind pub $quoteinfoauth $quoteinfocmd pubqsys::quoteinfo
  bind pub $delquoteauth $delquotecmd pubqsys::delquote
  bind pub $randquoteauth $randquotecmd pubqsys::randquote
  bind pub $lastquoteauth $lastquotecmd pubqsys::lastquote
  bind pub $findquoteauth $findquotecmd pubqsys::findquote
  bind pub $deletedquoteinfoauth $deletedquoteinfocmd pubqsys::deletedquoteinfo
  bind pub $undelquoteauth $undelquotecmd pubqsys::undelquote
  bind pub $forcedelquoteauth $forcedelquotecmd pubqsys::forcedelquote
  bind pub $cancelquoteauth $cancelquotecmd pubqsys::cancelquote
  bind evnt - prerehash pubqsys::uninstall 
  bind time - "[lindex $pubqsys::backuptime 1] [lindex $pubqsys::backuptime 0] * * *" pubqsys::backup_db
  proc uninstall {args} {
    unbind pub $quoteauth $quotecmd pubqsys::quote
    unbind pub $addquoteauth $addquotecmd pubqsys::addquote
    unbind pub $quoteinfoauth $quoteinfocmd pubqsys::quoteinfo
    unbind pub $delquoteauth $delquotecmd pubqsys::delquote
    unbind pub $randquoteauth $randquotecmd pubqsys::randquote
    unbind pub $lastquoteauth $lastquotecmd pubqsys::lastquote
    unbind pub $findquoteauth $findquotecmd pubqsys::findquote
    unbind pub $deletedquoteinfoauth $deletedquoteinfocmd pubqsys::deletedquoteinfo
    unbind pub $undelquoteauth $undelquotecmd pubqsys::undelquote
    unbind pub $forcedelquoteauth $forcedelquotecmd pubqsys::forcedelquote
    unbind pub $cancelquoteauth $cancelquotecmd pubqsys::cancelquote
...
proc pubqsys::antiflood {chan type} {
  ...
  if { $instance($chan$type) >= $max_instances } {
    if { $antiflood_msg($chan$type) == 0 } {
      ...
      utimer $pubqsys::antiflood_msg_interval "pubqsys::antiflood_msg_reset $chan $type"
    }
    return "flood"
  } else {
    incr instance($chan$type)
    utimer $instance_length "pubqsys::antiflood_close_instance $chan $type"
    return "no flood"
  }
}
