...
## Settings
set html(path) "/home/boqn/public_html/operwall/"
#-> Html settings
# Title of the main web page
set html(title) "OperWall логове"
# Background color
...
puts $fid "<html>\n<head><title>OperWall Лог от $date</title>\n<meta\
...
puts $fid "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=windows-1251\"><center><img src=\"http://88.87.10.89/operwall/logo.gif\"><br><table width=\"570\" border=\"0\" cellspacing=\"2\" cellpadding=\"0\">\n<tr>\n<td\
colspan=\"3\">\n<br><br>\n</td></tr>\n</table><center>\n</body>\n</html>"
close $fid
}
