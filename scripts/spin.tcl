...
#
  ...
  if {$mylength == 0} {
  putserv "PRIVMSG $chan :Е, $nick, няма никой за целуване.. :("
  return 0
  }
  ...
  "да целунеш"
  "да се надупиш на"
  "да оближеш ушенцето на"
  "да правиш секс с"
  "да поканиш на кафе"
  "бръкнеш в гащичките на"
  "да пуснеш език на"
}
#
# Build the suspense up somewhat
#
  putserv "PRIVMSG $chan :$nick завъртя бутилката ....."
  putserv "PRIVMSG $chan :Кой ли ще посочи никой не знае ...."
  putserv "PRIVMSG $chan :Завърта се сиилно ....."
  putserv "PRIVMSG $chan :.. и все по силно ....."
  putserv "PRIVMSG $chan :забавя се леко като почти спира"
  putserv "PRIVMSG $chan :посочвайки ..... $result!!!!"
  putserv "PRIVMSG $chan :Сега $nick трябва [lindex $rep [rand [llength $rep]]] $result!!!"
#
...
#
bind pub - !butilka spin_bunny
bind pub - "*zavurti butilkata*" spin_bunny
bind pub - !spin spin_bunny
bind pub - !vrutni spin_bunny
bind pub - !zavurti spin_bunny
putlog "Инсталиран: Spin.tcl"
