...
########################################################################
#                                                                    ###
#  BOT Protection Ver. 1.1 Release (eggdrop1.3.23+)                  ###
#  by Rambo (Rambo@dir.bg)                                           ###
#                                                                    ###
...
# Bot sets ban $nick!*@* and kicks the attacker
...
#	putlog "==> <$chan> Bot protection activated - banning $nick !!!!"
	...
	newban "$nick!*@*" $masterbanuser "$reswhat At $attack_time" 30
...
#putlog "BotProtect.tcl loaded | Downloaded from http://www.egghelp-bg.com/"