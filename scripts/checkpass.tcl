...
##  Version 1.8
##
##  Original script for eggdrop 1.0 by dJ_TEDY
...
proc checkpass:notice {nick} {
  global botnick
  puthelp "NOTICE $nick :You do not have a password & Email Set."
  puthelp "NOTICE $nick :Please set one now, by typing: /msg $botnick pass <your password>"
  puthelp "NOTICE $nick :Please set one now, by typing: /msg $botnick email <your m@il>"
  puthelp "NOTICE $nick :For more details: /msg $botnick help pass"
  return 1
}
...
putlog "CheckPass bY dJ_TEDY Loaded."